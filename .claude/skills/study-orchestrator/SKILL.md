...
1. **과목 판별.** 요청이 어느 과목인지 정한다. 단서: 카드·표지·AR·Lexile·단어장·서재 → 영어 / 문제·문제집·풀이·답·검산·플레이어·되감기 → 수학 / JLPT·N1~N5·한자·후리가나·히라가나·듀오링고·대화 복습·아빠 → 일본어. **"단어장"은 영어(은우)와 일본어(아빠) 양쪽에 있다** — JLPT·일본어 단서가 없으면 영어로 본다. **모호하면 물어본다** — 잘못 고르면 엉뚱한 스펙으로 작업한다.
