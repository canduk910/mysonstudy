 ...
 *
 * 영어 아래 세 학습(북카드·단어장·자유대화)을 동등 레벨로 고르는 진입 화면이다. 예전엔 이 경로가
 * "영어 랜딩 + 북카드 홈"을 겸했으나(단어장이 부차 링크로 얹혀 있었다), 이제 북카드 홈은
 * `/english/books`로 옮기고 여기는 **환영 + 카드 3개**만 담는다. 자유대화(SPEC §21 — Sunny 선생님과 전화영어)는
 * 2열 그리드의 셋째 칸이라 한 줄 전체(sm:col-span-2)를 쓴다(홈의 운동 타일과 같은 관용구).
 *
...
export const metadata: Metadata = {
  title: "영어 · 은우학습",
  description: "북카드로 책을 읽고, 단어장으로 단어를 정복하고, 자유대화로 영어로 말해 봐요.",
};
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 pb-16 pt-6">
      <header className="mb-8">
        ...
        <p className="t-lead mt-1">북카드·단어장·자유대화 중에서 골라 주세요.</p>
      </header>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <Link href="/english/talk" className="u-entry u-entry-secondary sm:col-span-2">
          <span className="u-entry-icon" aria-hidden>
            💬
          </span>
          <span className="u-entry-title">자유대화</span>
          <span className="u-entry-desc">
            Sunny 선생님과 영어로 전화하듯 이야기해요. 막히면 말해 볼 문장과 그림 카드가 떠요. 끝나면 문장마다 설명을 들어요.
          </span>
        </Link>
      </div>
    </main>
