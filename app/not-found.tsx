...
export default function NotFound() {
  return (
    <main className="mx-auto flex min-h-screen max-w-xl flex-col items-center justify-center gap-3 p-6 text-center">
      ...
      <p className="text-sm text-ink-2">주소가 바뀌었거나 아직 만들지 않은 카드예요.</p>
      <Link
        href="/"
        className="mt-2 rounded-xl border border-line bg-bg px-4 py-2.5 text-sm font-semibold text-ink"
      >
        ← 홈으로 돌아가기
      </Link>
    </main>
